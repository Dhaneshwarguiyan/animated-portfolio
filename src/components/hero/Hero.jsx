    ...
    <div className="hero">
      ...
      >
        <motion.div className="hero-text" variants={textvariants}>
          <motion.h1 variants={textvariants} className="hero-hello">
            Hello (); I am
          </motion.h1>
          <motion.h2 variants={textvariants}>DHANESHWAR GUIYAN</motion.h2>
          <motion.h1 variants={textvariants}>I design & code for web</motion.h1>
          <motion.div className="hero-button" variants={textvariants}>
            {/* <motion.button className="hero-button-1" variants={textvariants}>
              See the Latest Work
            </motion.button> */}
            {/* <motion.button
              className="hero-button-1"
              variants={textvariants}
